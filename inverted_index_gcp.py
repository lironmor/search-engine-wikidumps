...
# bucket = client.bucket("ir-course-ass-3")
#
...
#                 blob = bucket.get_blob(f"postings_gcp_{index_type}/" + f_name)
#                 self._open_files[f_name] = blob.open('rb')
#             # self._open_files[f_name] = open(f"postings_gcp_{index_type}/" + f_name, 'rb')
